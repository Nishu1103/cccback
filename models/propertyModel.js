...
const propertySchema = new mongoose.Schema({
  ...
  rentType: { type: String, enum: ['','Including AMC', 'Excluding AMC'], default: 'Including AMC' },  
  possession: { type: String, enum: ['','Ready to Move','Under Construction','In 18 months','In 12 months', 'In 6 months' ,'occupied'] , default: 'Ready to Move' },
